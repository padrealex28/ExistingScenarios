...
public class OneLondon_HO_DP_RM_to_DB {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputStream fis = new FileInputStream("D:\\Rate Matchers\\Alex One London - HO_DP - V2.xlsx");
		XSSFWorkbook workbook = new XSSFWorkbook(fis);
		List<String> sheetNames = new ArrayList<String>();
		List<String> rateFactors = new ArrayList<String>();
		logger.info(Thread.currentThread().getStackTrace()[1].getLineNumber() + ": STARTED FOR One London HO/DP RATER ");
		...
		for (int i = 0; i < sheetNames.size(); i++) {
			...
			String query = getQuery.OneLondon_HO_DP_RM_to_DB(i, rateFactors);
			logger.info(
		...
		cq.ComparePremium_OneLondon_HO_DP();	
		System.out.println();
